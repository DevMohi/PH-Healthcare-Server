...
const getAllFromDB = async (
  ...
  //For specialties extra
  //Doctor > doctorSpecialties table > specialties table -> title (filter apply korbo)
...
//user table ar doctor table theke delete korte hobe tai transaction use korse
