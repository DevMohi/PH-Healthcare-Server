...
CREATE TABLE "medial_reports" (
    ...
    CONSTRAINT "medial_reports_pkey" PRIMARY KEY ("id")
);
...
-- AddForeignKey
ALTER TABLE "medial_reports" ADD CONSTRAINT "medial_reports_patientId_fkey" FOREIGN KEY ("patientId") REFERENCES "patients"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
